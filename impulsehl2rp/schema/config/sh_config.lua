...
impulse.Config.SchemaVersion = 1
...
impulse.Config.SlowWalkRatio = 0.75
...
impulse.Config.PropLimit = 75
impulse.Config.PropLimitDonator = 150
...
impulse.Config.CurrencyPrefix = "C"
impulse.Config.CurrencyName = "credits"
...
impulse.Config.TeamChangeTime = 180
impulse.Config.TeamChangeTimeDonator = 30
...
impulse.Config.InventoryStorageMaxWeightVIP = 160 // no p2w
...
impulse.Config.DiscordURL = "https://discord.gg/W8aZgpGaHz"
...
impulse.Config.DoorGroups = {
	[1] = "Combine Entry Workforce",
	[2] = "Combine Entry Level 1",
	[3] = "Combine Entry Level 2",
}
...
impulse.Config.Achievements = {
	...
	["ach_kill"] = {
		Name = "Kill Someone",
		Desc = "You have killed someone. You feel guilty about it. You should do the same to yourself now...",
